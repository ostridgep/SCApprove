...
sap.ui.controller("view.Master", {
	...
	_updateList : function () {
		...
		if (searchString && searchString.length > 0) {
			var filter = new sap.ui.model.Filter("orderno", sap.ui.model.FilterOperator.Contains, searchString);
			filters.push(filter);
		}
		...
		var filterMap = {
			"ZM01" : new sap.ui.model.Filter("type", sap.ui.model.FilterOperator.EQ, "ZM01"),
			"ZM02" : new sap.ui.model.Filter("type", sap.ui.model.FilterOperator.EQ, "ZM02")
		};
		if (filterMap[key]) {
